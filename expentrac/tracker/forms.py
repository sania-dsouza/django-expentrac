...
class SignUpForm(forms.Form):
    ...
    password = forms.CharField(label="Password", max_length=8, help_text='8 characters min, 12 characters max. There must be two numbers and two special characters each.', widget=forms.PasswordInput(attrs={'placeholder': '********'}))
    cPassword = forms.CharField(label="Confirm Password", help_text='This must match the previous password field.', max_length=8, widget=forms.PasswordInput(attrs={'placeholder': '********'}))
